With our data ingested into the pipeline, we will now focus on verifying that **customer data** has been _successfully_ ingested into the **Bronze layer lakehouse**.
